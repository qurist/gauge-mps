...
//
#ifndef __ITENSOR_LADDER_H
#define __ITENSOR_LADDER_H
...
using Ladder = BasicSiteSet<LadderSite>;
...
class LadderSite
    ...
    LadderSite(Index I) : s(I) { }

    LadderSite(Args const& args = Args::global())
        {
        auto conserveQNs = args.getBool("ConserveQNs",true);
        auto conserveNb = args.getBool("ConserveNb",conserveQNs);

        auto tags = TagSet("Site,Ladder");
        auto n = 1;
